...
class HowitzerScene : public ISimulatorScene
{
public:
   HowitzerScene();
   ~HowitzerScene();
   ...
   double elevationDegrees() const;
   bool projectileActive() const;
   bool lastShotHitTarget() const;
   bool shotComplete() const;
   double targetDistanceMeters() const;
   double projectileAltitudeMeters() const;
