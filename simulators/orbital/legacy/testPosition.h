...
private:
   ...
   {
      // setup
      double metersFromPixels = MockPosition::metersFromPixels;
      MockPosition::metersFromPixels = 99.9;
      // exercise
      MockPosition pos;
      // verify
      ...
      // teardown
      MockPosition::metersFromPixels = metersFromPixels;
   }
