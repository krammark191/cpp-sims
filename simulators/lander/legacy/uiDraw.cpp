...
/************************************************************************
 * DRAW HUD TEXT
 * Draw larger Apollo HUD text with a stroke font and custom color.
 *************************************************************************/
void ogstream::drawHudText(const Position& posAnchor,
	const string& text,
	double scale,
	double red,
	double green,
...
{
	glPushMatrix();
	glTranslatef((GLfloat)posAnchor.getX(), (GLfloat)posAnchor.getY(), 0.0f);
