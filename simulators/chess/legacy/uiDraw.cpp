...
const int RGB_SELECTED[] = { 128, 255, 0 };
...
/************************************************************************
* DRAW COORDINATE HIGHLIGHT
* Highlight the rank/file labels for the hovered square
************************************************************************/
void ogstream::drawCoordinateHighlight(const Position& pos)
{
   if (pos.isInvalid())
      return;
   ...
   const GLfloat WIDTH_LETTER  = 4.0;
   const GLfloat HEIGHT_LETTER = 14.0;
   const GLfloat TEXT_MARGIN   = 2.0;
